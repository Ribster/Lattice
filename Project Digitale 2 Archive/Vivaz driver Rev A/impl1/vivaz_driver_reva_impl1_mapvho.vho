...
-- ldbanno -n VHDL -o vivaz_driver_reva_impl1_mapvho.vho -w -neg -gui vivaz_driver_reva_impl1_map.ncd 
-- Netlist created on Thu May 19 10:23:15 2016
-- Netlist written on Thu May 19 10:23:18 2016
...
-- entity SLICE_2
  ...
  begin
    count_149_150_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    count_149_150_add_4_7: ccu20003
...
-- entity SLICE_3
  ...
  begin
    count_149_150_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    count_149_150_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    count_149_150_add_4_5: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_4
  ...
  begin
    count_149_150_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    count_149_150_add_4_1: ccu20002
      port map (A0=>GNDI, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>GNDI, S0=>open, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_7
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    tmp_151_i5: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    tmp_151_add_4_7: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_8
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    tmp_151_i3: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    tmp_151_add_4_5: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_9
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    reset_startup_64: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity main
  ...
  entity main is
    port (lcd_bus: out Std_logic_vector (15 downto 0); lcd_rs: out Std_logic; 
          lcd_wr: out Std_logic; lcd_reset: in Std_logic; 
  ...
  architecture Structure of main is
    ...
    signal clk133_enable_8: Std_logic;
  ...
  begin
    SLICE_0I: SLICE_0
      port map (A1=>count_2, A0=>count_1, DI1=>n33, DI0=>n34, 
                LSR=>clk133_enable_9, CLK=>clk133, FCI=>n559, F0=>n34, 
                Q0=>count_1, F1=>n33, Q1=>count_2, FCO=>n560);
    SLICE_1I: SLICE_1
      port map (A1=>tmp_0, DI1=>n45, CE=>clk133_enable_8, CLK=>clk133, F1=>n45, 
                Q1=>tmp_0, FCO=>n562);
    SLICE_2I: SLICE_2
      port map (A0=>count_5, DI0=>n30, LSR=>clk133_enable_9, CLK=>clk133, 
                FCI=>n561, F0=>n30, Q0=>count_5);
    SLICE_3I: SLICE_3
      port map (A1=>count_4, A0=>count_3, DI1=>n31, DI0=>n32, 
                LSR=>clk133_enable_9, CLK=>clk133, FCI=>n560, F0=>n32, 
                Q0=>count_3, F1=>n31, Q1=>count_4, FCO=>n561);
    SLICE_4I: SLICE_4
      port map (A1=>n6, DI1=>n35, LSR=>clk133_enable_9, CLK=>clk133, F1=>n35, 
                Q1=>n6, FCO=>n559);
    SLICE_5I: SLICE_5
      port map (A1=>tmp_2, A0=>tmp_1, DI1=>n43, DI0=>n44, CE=>clk133_enable_8, 
                CLK=>clk133, FCI=>n562, F0=>n44, Q0=>tmp_1, F1=>n43, Q1=>tmp_2, 
                FCO=>n563);
    SLICE_6I: SLICE_6
      port map (A0=>tmp_7, DI0=>n38, CE=>clk133_enable_8, CLK=>clk133, 
                FCI=>n565, F0=>n38, Q0=>tmp_7);
    SLICE_7I: SLICE_7
      port map (A1=>tmp_6, A0=>tmp_5, DI1=>n39, DI0=>n40, CE=>clk133_enable_8, 
                CLK=>clk133, FCI=>n564, F0=>n40, Q0=>tmp_5, F1=>n39, Q1=>tmp_6, 
                FCO=>n565);
    SLICE_8I: SLICE_8
      port map (A1=>tmp_4, A0=>tmp_3, DI1=>n41, DI0=>n42, CE=>clk133_enable_8, 
                CLK=>clk133, FCI=>n563, F0=>n42, Q0=>tmp_3, F1=>n41, Q1=>tmp_4, 
                FCO=>n564);
    SLICE_9I: SLICE_9
      port map (D1=>tmp_2, C1=>tmp_7, B1=>n12, A1=>tmp_6, C0=>tmp_0, 
                B0=>lcd_te_c, A0=>n573, DI0=>lcd_te_N_87, CE=>clk133_enable_9, 
                CLK=>clk133, F0=>lcd_te_N_87, Q0=>lcd_te_c, F1=>n573);
    SLICE_10I: SLICE_10
      port map (D1=>tmp_0, C1=>n573, B1=>clk133_enable_9, A1=>lcd_te_c, D0=>n4, 
                C0=>count_4, B0=>count_3, A0=>count_5, F0=>clk133_enable_9, 
                F1=>clk133_enable_8);
    SLICE_11I: SLICE_11
      port map (D1=>tmp_5, C1=>tmp_4, B1=>tmp_3, A1=>tmp_1, B0=>count_2, 
                A0=>count_1, F0=>n4, F1=>n12);
    SLICE_12I: SLICE_12
      port map (F0=>VCC_net, F1=>GND_net);

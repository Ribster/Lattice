...
set newDesign 0
if {![file exists "Z:/GITHUB/Lattice/MachXO2700HETestproject/lcd_sender_a/lcd_sender_a.adf"]} { 
	design create lcd_sender_a "Z:/GITHUB/Lattice/MachXO2700HETestproject"
  set newDesign 1
}
design open "Z:/GITHUB/Lattice/MachXO2700HETestproject/lcd_sender_a"
...
vlib "Z:/GITHUB/Lattice/MachXO2700HETestproject/lcd_sender_a/work"
set worklib work
adel -all

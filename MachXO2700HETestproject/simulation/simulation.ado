...
set newDesign 0
if {![file exists "Z:/GITHUB/Lattice/MachXO2700HETestproject/simulation/simulation.adf"]} { 
	design create simulation "Z:/GITHUB/Lattice/MachXO2700HETestproject"
  set newDesign 1
}
design open "Z:/GITHUB/Lattice/MachXO2700HETestproject/simulation"
...
vlib "Z:/GITHUB/Lattice/MachXO2700HETestproject/simulation/work"
set worklib work
adel -all
